...
field: PIXI.Sprite;
    constructor () {
        ...
        this.field = PIXI.Sprite.from("https://s3-us-west-2.amazonaws.com/s.cdpn.io/693612/IaUrttj.png");
        this.field.x = 0;
        this.field.y = 0;
     ...
     //  await this.client.auth.login();
        ...
        this.room.state.entities.onAdd = (entity, sessionId: string) => {
            ...
            /*entity.onChange = (changes) => {
                const color = (entity.radius == 50) ?  0x00ff000: 0xFFFF0B;
